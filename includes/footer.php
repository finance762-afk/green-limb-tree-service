...
<dialog class="estimate-dialog" id="estimate-dialog" aria-labelledby="estimate-dialog-title">
    ...
    <div class="dialog-body">
        <form action="<?php echo htmlspecialchars($formAction); ?>" method="POST">
            ...
            <div class="form-grid">
                <div class="field"><label for="dlg-name">Your Name</label><input id="dlg-name" type="text" name="name" autocomplete="name" required></div>
                <div class="field"><label for="dlg-phone">Phone</label><input id="dlg-phone" type="tel" name="phone" autocomplete="tel" required></div>
                <div class="field full"><label for="dlg-email">Email</label><input id="dlg-email" type="email" name="email" autocomplete="email" required></div>
                <div class="field full"><label for="dlg-service">Service Needed</label>
                ...
                <div class="field full"><label for="dlg-message">Tell us about the tree(s)</label><textarea id="dlg-message" name="message" rows="3"></textarea></div>
            </div>
            ...
            <fieldset class="form-consent-fieldset">
                ...
                <label class="form-consent-item">
                    ...
                    <span class="consent-label"><strong>Email updates (optional):</strong> I agree to receive emails from <?php echo htmlspecialchars($siteName); ?> about my inquiry and services. I can unsubscribe anytime by emailing <?php echo htmlspecialchars($email); ?>.</span>
                </label>
                <label class="form-consent-item">
...
<!-- Cookie Bar (slim, appears after first scroll — dismissal wired in main.js) -->
<div class="cookie-bar" id="cookie-bar" role="dialog" aria-label="Cookie notice">
