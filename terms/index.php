...
<section class="hero hero--legal" aria-label="Terms of Service">
    <div class="hero__copy">
        ...
        <span class="section-subtitle">our policies & your rights</span>
...
<article class="legal-prose">
    ...
    <ul>
        ...
        <li>Work is performed by <?php echo $companyName; ?> employees and qualified subcontractors.</li>
    ...
    <p>These Terms are governed by the laws of the State of <?php echo $companyState; ?> without regard to conflict-of-laws principles. Any disputes shall be resolved in the state or federal courts located in <?php echo $address['city']; ?>, <?php echo $companyState; ?>.</p>
