...
$metaDescription = "How $siteName collects, uses, and protects your information. Privacy practices for our website and contact forms.";
...
<article class="legal-prose">
    ...
    <ul>
        ...
        <li><strong>Service providers:</strong> Google Analytics (analytics), our hosting provider, and Page One Insights, LLC (our web design partner — receives copies of contact form submissions via _cc field for lead-tracking purposes).</li>
