  ...
  <div class="container">
    <div class="sp-split">
      ...
      <div class="sp-split-image">
        <?php echo renderPicture('finished-lawn-after-removal', 'Lawn left clean after Green Limb tree work on a Greensboro property', 600, 400, '(min-width: 768px) 50vw, 100vw', []); ?>
      </div>
    </div>
  </div>
</section>
